...
publication: "_Environment and Planning B_"
publication_short: ""

# Summary. An optional shortened abstract.
summary: |
    High-density cities are shaped by volumetric urban design, including multi-level pedestrian networks and transit-oriented development (TOD). Conventional two-dimensional metrics fail to capture these features. This study develops measures of spatial compression, multi-level connectivity, and functional mix using detailed urban data. Results show 57% of buildings are vertically mixed-use, with commercial podiums and residential upper floors, alongside strong connectivity and dense space use. Traditional metrics miss up to 91% of compression and 52% of connectivity, and misclassify land use. The study proposes a transferable framework for analysing high-density, multi-layered urban environments.
...
image:
  caption: 'Study Design and Participants'
  focal_point: ""
  preview_only: false
...
[Click to access journal article](https://doi.org/10.1177/23998083261425731)